/**
 * Fuse.js v6.4.3 - Lightweight fuzzy-search (https://fusejs.io)
 *
 * Copyright (c) 2020 Kiro Risk (https://kiro.me)
...
;(function (global, factory) {
  ...
  function computeScore$1 (results, _ref8) {
    var _ref8$ignoreFieldNorm = _ref8.ignoreFieldNorm,
      ignoreFieldNorm =
        _ref8$ignoreFieldNorm === void 0
          ? Config.ignoreFieldNorm
          : _ref8$ignoreFieldNorm
  ...
  function format (results, docs) {
    var _ref10 =
      ...
      includeMatches =
        _ref10$includeMatches === void 0
          ? Config.includeMatches
          : _ref10$includeMatches,
      _ref10$includeScore = _ref10.includeScore,
      includeScore =
        _ref10$includeScore === void 0
          ? Config.includeScore
          : _ref10$includeScore
